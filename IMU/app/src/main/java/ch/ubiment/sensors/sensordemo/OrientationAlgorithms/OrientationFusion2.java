...
public class OrientationFusion2 {
    ...
    public Quaternion update(Quaternion absoluteOrientationQuaternion, float[] angularRate_xyz, float new_angular_ts){
        ...
        if (!positionInitialised) {
            ...
            localFlatQuaternion(relativeOrientationQuaternion);
     ...
     * Then modified to ignore asolute heading and keep only vertical vector of absolute orientation
     *
